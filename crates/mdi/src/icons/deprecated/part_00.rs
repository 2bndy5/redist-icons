...
#[deprecated]
pub const LANGUAGE_KOTLIN: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-language-kotlin" viewBox="0 0 24 24"><path d="M2 2H22L12 12L22 22H2Z"/></svg>"##,
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const GOOGLE_GLASS: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-google-glass" viewBox="0 0 24 24"><path d="M20 2H4C2.9 2 2 2.9 2 4V20C2 21.1 2.9 22 4 22H20C21.1 22 22 21.1 22 20V4C22 2.9 21.1 2 20 2M16.75 18H15.25V8.9L6.72 18H4.66L15.45 6.5C15.66 6.26 16 6.19 16.27 6.3C16.56 6.42 16.75 6.69 16.75 7V18Z"/></svg>"##,
    slug: "google-glass",
    version: "1.5.54",
    deprecated: true,
    author: "Google",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const GOOGLE_TRANSLATE: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-google-translate" viewBox="0 0 24 24"><path d="M20,5H10.88L10,2H4A2,2 0 0,0 2,4V17A2,2 0 0,0 4,19H11L12,22H20A2,2 0 0,0 22,20V7A2,2 0 0,0 20,5M7.17,14.59A4.09,4.09 0 0,1 3.08,10.5A4.09,4.09 0 0,1 7.17,6.41C8.21,6.41 9.16,6.78 9.91,7.5L10,7.54L8.75,8.72L8.69,8.67C8.4,8.4 7.91,8.08 7.17,8.08C5.86,8.08 4.79,9.17 4.79,10.5C4.79,11.83 5.86,12.92 7.17,12.92C8.54,12.92 9.13,12.05 9.29,11.46H7.08V9.91H11.03L11.04,10C11.08,10.19 11.09,10.38 11.09,10.59C11.09,12.94 9.5,14.59 7.17,14.59M13.2,12.88C13.53,13.5 13.94,14.06 14.39,14.58L13.85,15.11L13.2,12.88M13.97,12.12H13L12.67,11.08H16.66C16.66,11.08 16.32,12.39 15.1,13.82C14.58,13.2 14.21,12.59 13.97,12.12M21,20A1,1 0 0,1 20,21H13L15,19L14.19,16.23L15.11,15.31L17.79,18L18.5,17.27L15.81,14.59C16.71,13.56 17.41,12.34 17.73,11.08H19V10.04H15.36V9H14.32V10.04H12.36L11.18,6H20A1,1 0 0,1 21,7V20Z"/></svg>"##,
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const MICROSOFT_XBOX_CONTROLLER_VIEW: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-microsoft-xbox-controller-view" viewBox="0 0 24 24"><path d="M12,2C6.47,2 2,6.5 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M6,7H15V9H8V14H6V7M9,10H18V17H9V10M11,12V15H16V12H11Z"/></svg>"##,
    slug: "microsoft-xbox-controller-view",
    version: "3.6.95",
    deprecated: true,
    author: "GreenTurtwig",
};
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const LANGUAGE_HTML5: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-language-html5" viewBox="0 0 24 24"><path d="M12,17.56L16.07,16.43L16.62,10.33H9.38L9.2,8.3H16.8L17,6.31H7L7.56,12.32H14.45L14.22,14.9L12,15.5L9.78,14.9L9.64,13.24H7.64L7.93,16.43L12,17.56M4.07,3H19.93L18.5,19.2L12,21L5.5,19.2L4.07,3Z"/></svg>"##,
    slug: "language-html5",
    version: "1.5.54",
    deprecated: true,
    author: "Contributors",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const LITECOIN: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-litecoin" viewBox="0 0 24 24"><path d="M12.55,15.92L13.16,13.78L14.81,13.19L16.25,7.63L14.56,8.31L16.25,2H8L5.38,11.77L3.72,12.34L2.22,17.91L4,17.27L2.66,22H20.16L21.78,15.92H12.55M19.39,21H4L5.46,15.65L3.72,16.3L4.58,13.11L6.24,12.54L8.74,3H15L13.13,10L14.83,9.3L14,12.42L12.33,13L11.22,16.91H20.5L19.39,21Z"/></svg>"##,
    slug: "litecoin",
    version: "2.6.95",
    deprecated: true,
    author: "Contributors",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const GOOGLE_MAPS: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-google-maps" viewBox="0 0 24 24"><path d="M18.27 6C19.28 8.17 19.05 10.73 17.94 12.81C17 14.5 15.65 15.93 14.5 17.5C14 18.2 13.5 18.95 13.13 19.76C13 20.03 12.91 20.31 12.81 20.59C12.71 20.87 12.62 21.15 12.53 21.43C12.44 21.69 12.33 22 12 22H12C11.61 22 11.5 21.56 11.42 21.26C11.18 20.53 10.94 19.83 10.57 19.16C10.15 18.37 9.62 17.64 9.08 16.93L18.27 6M9.12 8.42L5.82 12.34C6.43 13.63 7.34 14.73 8.21 15.83C8.42 16.08 8.63 16.34 8.83 16.61L13 11.67L12.96 11.68C11.5 12.18 9.88 11.44 9.3 10C9.22 9.83 9.16 9.63 9.12 9.43C9.07 9.06 9.06 8.79 9.12 8.43L9.12 8.42M6.58 4.62L6.57 4.63C4.95 6.68 4.67 9.53 5.64 11.94L9.63 7.2L9.58 7.15L6.58 4.62M14.22 2.36L11 6.17L11.04 6.16C12.38 5.7 13.88 6.28 14.56 7.5C14.71 7.78 14.83 8.08 14.87 8.38C14.93 8.76 14.95 9.03 14.88 9.4L14.88 9.41L18.08 5.61C17.24 4.09 15.87 2.93 14.23 2.37L14.22 2.36M9.89 6.89L13.8 2.24L13.76 2.23C13.18 2.08 12.59 2 12 2C10.03 2 8.17 2.85 6.85 4.31L6.83 4.32L9.89 6.89Z"/></svg>"##,
    slug: "google-maps",
    version: "1.5.54",
    deprecated: true,
    author: "Google",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const MICROSOFT_XBOX_CONTROLLER: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-microsoft-xbox-controller" viewBox="0 0 24 24"><path d="M8.75,15.75C6.75,15.75 6,18 4,19C2,19 0.5,16 4.5,7.5H4.75L5.19,6.67C5.19,6.67 8,5 9.33,6.23H14.67C16,5 18.81,6.67 18.81,6.67L19.25,7.5H19.5C23.5,16 22,19 20,19C18,18 17.25,15.75 15.25,15.75H8.75M12,7A1,1 0 0,0 11,8A1,1 0 0,0 12,9A1,1 0 0,0 13,8A1,1 0 0,0 12,7Z"/></svg>"##,
    slug: "microsoft-xbox-controller",
    version: "1.5.54",
    deprecated: true,
    author: "Austin Andrews",
};
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const MICROSOFT_XBOX_CONTROLLER_BATTERY_MEDIUM: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-microsoft-xbox-controller-battery-medium" viewBox="0 0 24 24"><path d="M21,12V7H15V12H21M21.67,5C22.4,5 23,5.6 23,6.33V19.67A1.33,1.33 0 0,1 21.67,21H14.33C13.6,21 13,20.4 13,19.67V16.75H7.75C5.75,16.75 5,19 3,20C1,20 -0.5,17 3.5,8.5H3.75L4.19,7.67C4.19,7.67 7,6 8.33,7.23H13V6.33A1.33,1.33 0 0,1 14.33,5H16V3H20V5H21.67M11,8A1,1 0 0,0 10,9A1,1 0 0,0 11,10A1,1 0 0,0 12,9A1,1 0 0,0 11,8Z"/></svg>"##,
    slug: "microsoft-xbox-controller-battery-medium",
    version: "1.9.32",
    deprecated: true,
    author: "Austin Andrews",
};
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const TERRAFORM: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-terraform" viewBox="0 0 24 24"><path d="M21 5.4V11.8L15.4 15V8.7L21 5.4M14.8 8.7V15L9.2 11.8V5.4L14.8 8.7M14.8 15.7V22.1L9.2 18.9V12.5L14.8 15.7M8.6 5.1V11.5L3 8.3V1.9L8.6 5.1Z"/></svg>"##,
    slug: "terraform",
    version: "4.1.95",
    deprecated: true,
    author: "Contributors",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const TWITCH: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-twitch" viewBox="0 0 24 24"><path d="M11.64 5.93H13.07V10.21H11.64M15.57 5.93H17V10.21H15.57M7 2L3.43 5.57V18.43H7.71V22L11.29 18.43H14.14L20.57 12V2M19.14 11.29L16.29 14.14H13.43L10.93 16.64V14.14H7.71V3.43H19.14Z"/></svg>"##,
    slug: "twitch",
    version: "1.5.54",
    deprecated: true,
    author: "Contributors",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const GOODREADS: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-goodreads" viewBox="0 0 24 24"><path d="M17,12.77C15.96,14.42 14.22,15.5 12.25,15.5C9.07,15.5 6.5,12.7 6.5,9.25C6.5,5.8 9.07,3 12.25,3C14.22,3 15.96,4.08 17,5.73V3H18V15.25C18,20.71 14.54,21 11.5,21C9,21 7.55,19.31 7.13,17H8.14C8.5,18.75 9.54,20 11.5,20C13.72,20 17,20.05 17,15.25V15.25L17,12.77M12.25,4C9.63,4 7.5,6.35 7.5,9.25C7.5,12.15 9.63,14.5 12.25,14.5C14.87,14.5 17,12.15 17,9.25C17,6.35 14.87,4 12.25,4Z"/></svg>"##,
    slug: "goodreads",
    version: "3.4.93",
    deprecated: true,
    author: "Contributors",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const MICROSOFT_DYNAMICS_365: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-microsoft-dynamics-365" viewBox="0 0 24 24"><path d="M6,2L17.25,8.5L13.5,11.5L6,8V2M6,9L9.5,11.25L6,22L18,9V15L6,22V9Z"/></svg>"##,
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const GITLAB: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-gitlab" viewBox="0 0 24 24"><path d="M21.94 13.11L20.89 9.89C20.89 9.86 20.88 9.83 20.87 9.8L18.76 3.32C18.65 3 18.33 2.75 17.96 2.75C17.6 2.75 17.28 3 17.17 3.33L15.17 9.5H8.84L6.83 3.33C6.72 3 6.4 2.75 6.04 2.75H6.04C5.67 2.75 5.35 3 5.24 3.33L3.13 9.82C3.13 9.82 3.13 9.83 3.13 9.83L2.06 13.11C1.9 13.61 2.07 14.15 2.5 14.45L11.72 21.16C11.89 21.28 12.11 21.28 12.28 21.15L21.5 14.45C21.93 14.15 22.1 13.61 21.94 13.11M8.15 10.45L10.72 18.36L4.55 10.45M13.28 18.37L15.75 10.78L15.85 10.45H19.46L13.87 17.61M17.97 3.94L19.78 9.5H16.16M14.86 10.45L13.07 15.96L12 19.24L9.14 10.45M6.03 3.94L7.84 9.5H4.23M3.05 13.69C2.96 13.62 2.92 13.5 2.96 13.4L3.75 10.97L9.57 18.42M20.95 13.69L14.44 18.42L14.46 18.39L20.25 10.97L21.04 13.4C21.08 13.5 21.04 13.62 20.95 13.69"/></svg>"##,
    slug: "gitlab",
    version: "3.0.39",
    deprecated: true,
    author: "Contributors",
...
/// DEPRECATED: This icon will be removed in a future version.
#[deprecated]
pub const ANDROID: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" id="mdi-android" viewBox="0 0 24 24"><path d="M16.61 15.15C16.15 15.15 15.77 14.78 15.77 14.32S16.15 13.5 16.61 13.5H16.61C17.07 13.5 17.45 13.86 17.45 14.32C17.45 14.78 17.07 15.15 16.61 15.15M7.41 15.15C6.95 15.15 6.57 14.78 6.57 14.32C6.57 13.86 6.95 13.5 7.41 13.5H7.41C7.87 13.5 8.24 13.86 8.24 14.32C8.24 14.78 7.87 15.15 7.41 15.15M16.91 10.14L18.58 7.26C18.67 7.09 18.61 6.88 18.45 6.79C18.28 6.69 18.07 6.75 18 6.92L16.29 9.83C14.95 9.22 13.5 8.9 12 8.91C10.47 8.91 9 9.24 7.73 9.82L6.04 6.91C5.95 6.74 5.74 6.68 5.57 6.78C5.4 6.87 5.35 7.08 5.44 7.25L7.1 10.13C4.25 11.69 2.29 14.58 2 18H22C21.72 14.59 19.77 11.7 16.91 10.14H16.91Z"/></svg>"##,
    slug: "android",
    version: "1.5.54",
    deprecated: true,
    author: "Google",
