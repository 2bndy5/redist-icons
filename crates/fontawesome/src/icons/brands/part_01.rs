...
/// brands/roblox-creator-studio
pub const BRANDS_ROBLOX_CREATOR_STUDIO: Icon = Icon {
    svg: r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M330.3 329.5L349 259.7 498.9 299.9 440 519.5 24 408 64.2 258.2 330.3 329.5zm221.2-226L511.3 253.3 245.2 182 226.5 251.8 76.6 211.7 135.5-8 551.5 103.5z"/></svg>"##,
    slug: "roblox-creator-studio",
    last_modified: 1774533929,
    family: "brands",
    width: 576,
    height: 512,
    label: "Roblox Creator Studio",
};
